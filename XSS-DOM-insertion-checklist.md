...
| 970 | populateCategorySelect | option `${c}` (kategori) | Attribute için kaçış önerilir |
...
| 1785 | allocation popup HTML | person, amount | Kontrol önerilir |
...
| Satır (yaklaşık) | Konum | Veri | Durum |
|------------------|--------|------|--------|
| 146, 181, 217, 228 | İşlem listesi, kategoriler | Kategori / işlem verisi | Sanitize kontrolü önerilir |
| 349, 496, 543 | Düzenle modal, kategori detay | Kategori adı, işlem alanları | Sanitize önerilir |

---

*Son güncelleme: Faz 1 uygulaması ile.*
